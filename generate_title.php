...
if (!isset($_SESSION['guardianID'])) {
    ...
    file_put_contents('C:/xampp/htdocs/DreamScribeAi/generate.log', "Response: " . json_encode($response) . "\n\n", FILE_APPEND);
...
$command = "python C:/xampp/htdocs/DreamScribeAi/app.py $title_arg $empty_arg $empty_arg $language_arg $voice_arg --generate-from-title";
...
file_put_contents('C:/xampp/htdocs/DreamScribeAi/generate.log', $log, FILE_APPEND);
...
file_put_contents('C:/xampp/htdocs/DreamScribeAi/generate.log', "Last Output Line: $json_output\n", FILE_APPEND);
...
file_put_contents('C:/xampp/htdocs/DreamScribeAi/generate.log', "Response: " . json_encode($response, JSON_UNESCAPED_UNICODE) . "\n\n", FILE_APPEND);
echo json_encode($response);
?>