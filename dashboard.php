...
$name = isset($_SESSION['firstName']) ? htmlspecialchars($_SESSION['firstName']) : 'User';
?>
...
<head>
    ...
    <title>Dream Scribe AI - Dashboard</title>
...
<body>
    ...
    <div class="header-section">
        <div class="header-content">
            ...
            <p>Get ready to explore a world full of creative stories and unique experiences! 🚀</p>
        </div>
    </div>
    ...
    <div class="main-section">
        <div class="main-container">
            ...
            <a href="create-room.php" class="button">START</a>
        </div>
    </div>
</body>
</html>